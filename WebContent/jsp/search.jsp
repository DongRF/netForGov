...
<body class="tableWH" style="position: absolute;" onload="search()">
	<div id="mainDiv"  class="tableWH">
		...
		<div id="secondDiv">
			<table style="width:80%;">
				<tr>
					...
					<td align="center"><a href="javascript:void(0);" onclick="searchjumpPage('zwgk')"><img src="./../resource/img/word2.png" class="imgBottom"><span class="spanBottom">&nbsp;&nbsp;政务公开</span></a></td>
					<td align="center"><a href="javascript:void(0);" onclick="searchjumpPage('zwgk')"><img src="./../resource/img/word4.png" class="imgBottom"><span class="spanBottom">&nbsp;&nbsp;走进寿光</span></a></td>
					<td align="center"><a href="javascript:void(0);" onclick="searchjumpPage('bmdh')"><img src="./../resource/img/word9.png" class="imgBottom"><span class="spanBottom">&nbsp;&nbsp;部门导航</span></a></td>
		...
		<div id="searchDiv">
			<div id="topSearchDiv">
				<span style="color: red;">&emsp; ┃ </span><span style="font-weight: bolder;">搜索结果</span>
			</div>
			<div id="mianSearchDiv">
			</div>
		</div>
				<div id="bottomDiv">
